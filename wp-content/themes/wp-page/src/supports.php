...
if ( ! function_exists( 'wpg_add_theme_supports' ) ) {
	/**
	 ...
	 * @return void
	 */
	function wpg_add_theme_supports() {
		/**
...
add_action( 'after_setup_theme', 'wpg_add_theme_supports' );

if ( ! function_exists( 'wpg_load_textdomain' ) ) {
	/**
	...
	function wpg_load_textdomain() {
		load_theme_textdomain( 'wpg', get_template_directory() . '/resources/languages' );
	}
}
add_action( 'after_setup_theme', 'wpg_load_textdomain' );
